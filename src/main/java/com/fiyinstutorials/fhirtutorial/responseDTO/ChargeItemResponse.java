...
public class ChargeItemResponse {
    ...
    private List<ReferenceDTO> reasonReferences;
    private List<ReferenceDTO> serviceReferences;
    private ReferenceDTO productReferences;
    private ReferenceDTO accountReferences;
